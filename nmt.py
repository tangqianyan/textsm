...
class NMTModel(object):
    ...
    def forward(self, src_input, src_size, trg_input, trg_label, trg_size):
        ...
        with tf.variable_scope("decoder"):
            enc_state = self.dec_cell.zero_state(batch_size,np.float32)
        ...
        return cost_per_token, train_op,enc_state
...
def main():
    ...
    cost_op, train_op,enc_value= train_model.forward(src, src_size, trg_input,
                                            trg_label, trg_size)
